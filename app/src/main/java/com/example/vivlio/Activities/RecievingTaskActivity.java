...
public class RecievingTaskActivity extends AppCompatActivity {
    ...
    /**
     * Gets list of books that the current user has lent. Displays that
     * list of book with their title, author and borrower. Once the user selects a book, the scanner will
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_recievetask);

        ListView BookListLV;

        BookListLV = findViewById(R.id.RECIEVE_LVbooks);
    ...
    public void openScanner(){
        Intent intent = new Intent(RecievingTaskActivity.this, BarcodeScannerActivity.class);
